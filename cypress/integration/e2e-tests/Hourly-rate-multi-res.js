...
// run the hourly nandoca journey in different screen resolutions
  ...
  sizes.forEach((size) => {
    ...
    it(`Should display page title on ${size} screen`, () => {
      if (Cypress._.isArray(size)) {
        ...
        cy.get(':nth-child(1) > .button__Wrapper-oyjxxm-0 > .button__BottomHalf-oyjxxm-2').contains('Team Member').click()       
        cy.waitFor(5000)
