...
describe('Hourly Nandocas', function ()
    {
        it('Verify homepage url, title and hero text', function () {
                ...
                cy.visit("https://preprod.careers.nandos.co.uk/") //visit site
                ...
                cy.get('.hero__SubWrapper-sc-7mvbl5-2.cJJTMe').contains("Heart and soul. Passion and personality. You may know us as the home of PERi-PERi goodness, but we like to think of ourselves as more than that. At Nando’s, it’s the people that make the chicken.") // verify homepage hero text
